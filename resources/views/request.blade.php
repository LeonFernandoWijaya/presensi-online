        ...
        <div class="lg:w-1/2 w-full flex flex-col justify-center md:mt-20 mt-0 gap-4 bg-white rounded-2xl">
            <div class="rounded-2xl shadow-2xl flex flex-col gap-4">
                ...
                <form class="p-4 md:p-5 flex flex-col gap-4">
                    <div>
                        <label for="customer" class="block mb-2 text-sm font-medium text-gray-900">Customer<span
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="flex flex-col">
                            <label for="overtimeEnd" class="block mb-2 text-sm font-medium text-gray-900">Overtime End<span
                                    class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="3"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            required="" placeholder="Enter your notes"></textarea>
                    </div>

                    <div class="flex items-center justify-center">
                        <button type="button" onclick="saveRequest()"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 w-full focus:outline-none">Submit</button>
