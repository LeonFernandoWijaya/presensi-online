            ...
            success: function(response) {
                ...
                response.data.forEach(shift => {
                    ...
                    <td class="px-6 py-4 flex items-center gap-2">
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onclick="showEditShiftModal(${shift.id})">Edit</button>
                ...
                response.shift_days.forEach(day => {
                    ...
                    <div class="rounded-xl border border-gray-200 shadow-sm flex items-center justify-between px-4 py-2">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button type="button" onclick="deleteShiftDay(${day.id})" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
