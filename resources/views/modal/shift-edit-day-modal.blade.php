            ...
            <form class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="editStartHour"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Start Hour<span
                ...
                <button type="button" onclick="updateShiftDay()"
                    class="w-full text-white flex justify-center items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Edit Day
                </button>
            </form>
        </div>
