<!-- Main modal -->
<div id="shift-add-day-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    onclick="hideFlowBytesModal('shift-add-day-modal')">
            ...
            <form class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="dayName" class="block mb-2 text-sm font-medium text-gray-900">Day
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="startHour" class="block mb-2 text-sm font-medium text-gray-900">Start Hour<span
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="endHour" class="block mb-2 text-sm font-medium text-gray-900">End
                ...
                <button type="button" onclick="addShiftDay()"
