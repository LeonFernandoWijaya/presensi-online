<!-- Main modal -->
<div id="create-new-shift-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    onclick="hideFlowBytesModal('create-new-shift-modal')">
            ...
            <form class="p-4 md:p-5">
                <div class="mb-5">
                    <label for="shiftName" class="block mb-2 text-sm font-medium text-gray-900">Shift
