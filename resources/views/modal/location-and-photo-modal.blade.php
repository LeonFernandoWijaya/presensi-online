    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h3 class="text-lg font-semibold text-gray-900" id="locationAndPhotoModalTitle">
                </h3>
                <button type="button"
            ...
            <form class="p-4 md:p-5">
                ...
                <div class="flex items-center gap-2 mb-5">
                    <button type="button" onclick="refreshLocation()"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full w-full text-sm px-5 py-2.5 focus:outline-none">Get
                        My Location</button>
                    <button type="button"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full w-full text-sm px-5 py-2.5 focus:outline-none"
                ...
                <div class="grid grid-cols-2 gap-3 mb-5">
                    ...
                    <div>
                        <label for="activityTypes" class="block mb-2 text-sm font-medium text-gray-900">Activity
                    ...
                    <div>
                        <label for="activityCategories" class="block mb-2 text-sm font-medium text-gray-900">Activity
                    ...
                    <div>
                        <label for="photo" class="block mb-2 text-sm font-medium text-gray-900">Photo
                            <span class="text-red-500">*</span></label>
                ...
                <button id="locationAndPhotoModalSubmit" type="button" onclick="presenceNow()"
                    class="mt-2 text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center w-full justify-center">
                </button>
            </form>
        </div>
    </div>
