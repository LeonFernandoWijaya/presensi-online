        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5">
                ...
                <div class="flex items-center gap-2 mb-5">
                    ...
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full w-full text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onclick="openCameraModal()">Get My Photo</button>
                ...
                <div class="grid grid-cols-2 gap-2 mb-5">
                    ...
                    <div class="h-32 w-32 border rounded-lg border-gray-400 flex items-center justify-center" id="previewPhoto">
