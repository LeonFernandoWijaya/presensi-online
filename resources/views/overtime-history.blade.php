        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.attendance == null){
                    ...
                    $('#photoIn').empty();
                    $('#photoIn').append(`<img src="{{ asset('storage/photos/${response.attendance.clockInPhoto}') }}" class="w-32 h-32 object-cover rounded-lg">`);
                    $('#photoOut').empty();
                    $('#photoOut').append(`<img src="{{ asset('storage/photos/${response.attendance.clockOutPhoto}') }}" class="w-32 h-32 object-cover rounded-lg">`);
                }
